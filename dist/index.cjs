...
const p = async (e, t, n) => {
	...
	if (
		(e.headers.upgrade ||
			((u = e == null ? void 0 : e.headers) == null ? void 0 : u.get('Upgrade'))) !== 'websocket' &&
		!t
	)
		return;
	let o;
		...
		d &&
			(await d(e, () => {
				if (t) {
					...
					const i = globalThis,
						r = new i.WebSocketPair(),
						a = r[0],
						f = r[1];
					return (o = new Response(null, { status: 101, webSocket: a })), f;
				}
			})),
		o
	);
