"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const c={},u={};let a;const f=async(e,t,o)=>{const{pathname:s}=new URL(e.url||"","wss://base.url"),r=c[s];if(r)if(t){let n=u[s];n||(n=new a({noServer:!0}),u[s]=n,n.on("connection",i=>{r(i,i)})),n.handleUpgrade(e,t,o,i=>{n.emit("connection",i,e)})}else{const n=e.headers.get("Upgrade");if(!n||n!=="websocket")return;const i=new WebSocketPair,l=i[0],d=i[1];return r(d,l),new Response(null,{status:101,webSocket:l})}},p=globalThis;function w(){return{name:"svelte-kit-websocket",async transform(e,t){if(t.endsWith("@sveltejs/kit/src/runtime/server/index.js")){e=`import {dev} from "$app/environment";
